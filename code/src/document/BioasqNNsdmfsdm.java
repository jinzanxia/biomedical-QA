...
public class BioasqNNsdmfsdm {
	...
	public static void main(String[] args) throws Exception {
		String batchFile="bioasq5b_batch2/questions/";
		String outqueriesFileName="bioasq5b_batch2/doc_queries/nn/bioasq5b_batch2_NNsdmfsdmw3.queries";
		String baseTxt="lib/basefsdmw3.txt";
		BioasqNN bioasqNN = new BioasqNN();
