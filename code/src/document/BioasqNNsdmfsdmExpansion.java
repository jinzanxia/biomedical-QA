...
public class BioasqNNsdmfsdmExpansion {
		 ...
		 for(int i=1;i<=num;i++){
			 ...
			 if(str6.trim().length()>0){
				 ...
				 if(str9.trim().length()>0){
					 ...
					 bufferedWriter.write("    \"text\" : \"#combine(#sdm("+str3.trim()+"))\"");						 						
				 }
			 }
	...
	public static void main(String[] args) throws Exception {
		...
		String outqueriesFileName="bioasq5b_batch5/doc_queries/nn/bioasq5b_batch5_NNsdmfsdmw3_expansionw2.queries";
		String baseTxt="lib/basefsdmw2.txt";
		String expansionFile="bioasq5b_batch5/doc_expansion/nnTitle/";
		BioasqNNsdmfsdmExpansion bioasqSDMExpansion = new BioasqNNsdmfsdmExpansion();
